...
<div class="container">
     <div class="copyright-txt">
		...
		<?php } else { ?>
        	<?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','maintenance-services');?> <a href="<?php echo esc_url('https://www.sktthemes.org/product-category/construction/');?>" target="_blank">
        <?php esc_html_e('SKT Construction Themes','maintenance-services'); ?>
        </a>
        <?php } ?>
        </div>
     <div class="clear"></div>
